...
if __name__ == '__main__':
    ...
    navi_path = Path(f"E:/dataset/Navi/2_result_trans_repo_{dataset_name}")
    results_path = Path(f"E:/dataset/Navi/2_consistent_genpat_result_trans_repo_{dataset_name}")
