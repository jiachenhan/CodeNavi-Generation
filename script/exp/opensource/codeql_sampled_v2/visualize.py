...
if __name__ == "__main__":
    result_path = Path("E:/dataset/Navi/result_trans_repo_codeql_sampled_v2/navi_result_store.json")
    store_path = Path("E:/dataset/Navi/result_trans_repo_codeql_sampled_v2/det_num_his.png")
