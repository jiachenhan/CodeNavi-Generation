...
def run_query(_query_base_path: Path, _dataset_path: Path):
    engine_path = Path(r"C:\Users\frexv\Desktop\codenavi\kirin-cli-1.0.8_sp06-jackofext-obfuscate.jar")
...
if __name__ == '__main__':
    query_base_path = Path(r"C:\Users\frexv\Desktop\codenavi\CodeNavi-Generation/07dsl/gpt-4o/ql")
    dataset_path = Path(r"C:\Users\frexv\Desktop\codenavi\ql")
